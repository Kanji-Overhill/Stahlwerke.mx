...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/aplicaciones" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
	 <iframe id="player" src="http://www.youtube.com/embed/JTXj8I2Hyq4?autoplay=1&loop=1&playlist=JTXj8I2Hyq4&showinfo=0&controls=0" frameborder="0" allowfullscreen></iframe>
		...
		<section class="scroll-page">
			<article>
				<h1>Aplicaciones</h1>
		        <p class="text-bold-2">MARKETING Y VENTAS</p>
		        <ul class="lista-2-colores">
		        	<li>Visualización conceptos</li>
		        	<li>Animar procesos</li>
		        	<li>Ejemplificar lo complejo</li>
		        </ul>
		        <p class="text-bold-2">Planeación</p>
		        <ul class="lista-2-colores">
		        	<li>Revisar parámetros de planeación</li>
		        	<li>Evaluar alternativas</li>
		        	<li>Identificar cuellos de botella</li>
		        	<li>Optimizar soluciones</li>
		        </ul>
		        <p class="text-bold-2">Ingeniería</p>
		        <ul class="lista-2-colores">
		        	<li>Análisis de Componentes sensibles</li>
		        	<li>Puesta en marcha de sistemas de control vía modelo de simulación</li>
		        	<li>Verificación de la instalación </li>
		        </ul>
		        <p class="text-bold-2">Operación</p>
		        <ul class="lista-2-colores">
		        	<li>Distribución de personal basado en simulación </li>
		        	<li>Secuencias</li>
		        </ul>
