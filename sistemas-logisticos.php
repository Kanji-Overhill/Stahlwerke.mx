...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/sistemas-logisticos" />
</head>
<body>
	<header>
		<nav>
			<a href="index" class="logo">
				<img class="logo1" src="images/logo1.png" alt="estructuras metalicas, naves industriales, equipos industriales">
				<img class="logo2" src="images/logo2.png" alt="estructuras metalicas, naves industriales, equipos industriales">
			</a>
			<ul class="menu-principal">
				...
				<li>
				    <div for="">
				    	...
				    	<li><a href="sistemas-almacenamiento">Sistemas lógicos de almacenamiento automatizado</a></li>
				        </ul>
				    </div>
				</li>
				<li>
				    ...
				    <ul class="sub-menu" id="sub-2">
				    	...
				    	<li><a href="diseño-fabricacion">Diseño y Fabricación</a></li>
				    	<li><a href="simulacion">Simulacion</a></li>
				    	<li><a href="sistemas-logicos">Sistemas Logísticos</a></li>
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/sistemas-logisticos.jpg);">
			<article>
		...
		<section class="scroll-page">
			<article>
				<h1>Sistemas logísticos</h1>
			<div class="img-left">
				<img src="images/logistico-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p>Diseño, fabricación, integración, instalación y puesta en  marcha de sistemas automatizados para almacenes logísticos en general, contamos con experiencia en el ramo de automatización de estacionamientos urbanos. Integramos componentes ede la más alta calidad Europea con presencia y servicio técnico en América. Así mismo contamos con la integración de sistemas de software de gestión inteligente que permiten controlar las secuencias dentro del almacén.</p>
			</div>
			<h2>Beneficios</h2>
			<ul class="lista-2-colores">
				<li>Reducción de costos de reurbanización</li>
				<li>Eficiente y económico</li>
				<li>Ahorro de contrucción (Excavación)</li>
				<li>No Rampas.</li>
			...
			<p class="text-bold">
				También ofrecemos apoyo para la obtención de la certificacion LEED (Leadership in Energy & Environmental Design) 
			</p>
