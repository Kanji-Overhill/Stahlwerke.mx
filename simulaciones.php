...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/simulaciones" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/simula-1.jpg);">
			<article>
		...
		<section class="scroll-page">
		    ...
		    Somos capaces de diseñar y manufacturar equipos industriales como:<br>
		    Intercambiadores de calor, reactores, suavizadores de agua, filtros de aire, filtros de carbono y antracita, colectores de polvo, secadores de arena, silos, elevadores, bandas, contenedores presurizados, tanques atmosféricos, tanques de presión</p>
			<img class="imagen-total" src="images/simula-2.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
			...
			Mediante la experiencia en la industria, podemos sugerir a nuestros clientes la estructura o equipo ideal para su proceso, incluyendo dimensionamiento, selección de materiales y simulaciones previas a la fabricación.</p>
			<div class="img-left">
				<img src="images/simula-3.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
