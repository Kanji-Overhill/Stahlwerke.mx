...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/simulacion" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/simulaciones.jpg); background-size: cover;">
			<article>
		...
		<section class="scroll-page">
			<article>
				<h1>Simulación</h1>
				<h2>Propósitos y objetivos</h2>
			<ul class="lista-2-colores">
				<li>Analizar capacidad y desempeño</li>
				<li>Estudios de factibilidad</li>
				<li>Estudios comparativos</li>
				<li>Análisis sensibles</li>
				<li>Estudios de optimización</li>
				<li>Análisis de cuellos de botella</li>
				<li>Visualización</li>
			</ul>
			<h2>Beneficios</h2>
			<ul class="lista-cuadrados">
				<li>Determinación de ciclos de tiempo</li>
				<li>Evaluación de capacidad necesaria</li>
				<li>Estimación de carga de trabajo</li>
				<li>Indentificación picos de demanda y cuellos de botella</li>
				<li>Valoración de reglas de control</li>
				<li>Coordinación de modelos de cambio</li>
				<li>Derivación de estrategias de riesgo</li>
				<li>Valifación de compra y ubicación de equipos</li>
			</ul>
			<img class="imagen-total" src="images/simulaciones-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
