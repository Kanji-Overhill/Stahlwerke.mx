...
<head>
	...
	<meta name="description" content="En StahlWerke diseñamos y construimos naves industriales, brazos articulados, equipos industriales, bandas transportadoras, racks industriales, y mucho mas">
	...
	<link rel="canonical" href="http://stahlwerke.mx/brazos-articulados" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		...
		<section class="scroll-page">
			<article>
				...
				<b>articulados</b></h1>
				<h2>Ventajas</h2>
		        <p><b>Flexibilidad máxima</b><br>
		        Estos brazos pueden ser utilizados en diversos ambientes de manufactura permitiendo con esto facilitar el trabajo en diferente actividades</p>
		        <div class="img-left-min">
				<img src="images/brazos-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p><b>Cobertura máxima de espacio</b><br>
				Mediante el sistema de movimiento programado y fisicamente posible, este tipo de brazos permite que la cobertura de espacio se extienda en comparación con otro tipo de brazos.<br><br>
				<b>Fácil mantimiento<br></b>
				El tipo de uniciones utilizadas para los brazos permite que sean fáciles de sellar contra el polvo, permitiendo de esta manera evitar mantenimientos innecesarios en ambientes de manufactura.</p>
			</div>
			<p><b>Fácil utilización con motores eléctricos</b><br>
			El sistema es compatible con una gran gama de motores eléctricos, lo que permite que el sistema  cumpla con las especificaciones del cliente.</p>
			<p><b>Gran alcance</b><br>
			El brazo articulado puede alcanar sobre y bajo objetos, de tal manera incrementando el rango de alcance y permitiendo tener mayor flexibilidad en utilización.</p>
