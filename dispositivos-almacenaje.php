...
<head>
	...
	<meta name="description" content="En StahlWerke diseñamos y construimos naves industriales, estructuras metálicas, equipos industriales, pallet industrial, racks industriales, y mucho mas">
	...
	<link rel="canonical" href="http://stahlwerke.mx/dispositivos-almacenaje" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
	 <iframe id="player" src="http://www.youtube.com/embed/JTXj8I2Hyq4?autoplay=1&loop=1&playlist=JTXj8I2Hyq4&showinfo=0&controls=0" frameborder="0" allowfullscreen></iframe>
		...
		<section class="scroll-page">
			<article>
				<h1><b>Dipositivos de</b><br>almacenaje</h1>
		        <p>Algunos de nuestros productos orientados a la logística son:</p>
		        <ul class="lista-2-colores">
		        	<li>Racks</li>
		        	<li>Tinas</li>
		        	<li>Rejas</li>
		        	<li>Bastidores</li>
		        	<li>Estructuras para estaciones de trabajo</li>
		        </ul>
		        <p>Estos sistemas sirven para el transporte de materiales metálicos, plásticos, combinados, siguiendo especificaciones técnicas, dibujos y sistemas como el Just In Time.</p>
