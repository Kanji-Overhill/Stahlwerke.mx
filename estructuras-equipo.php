...
<head>
	...
	<meta name="description" content="En StahlWerke diseñamos y construimos naves industriales, estructuras metálicas, equipos industriales, soldaduras industriales, tinas industriales y mucho mas">
	...
	<link rel="canonical" href="http://stahlwerke.mx/estructuras-metalicas" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/estructura.jpg);">
			<article>
		...
		<section class="scroll-page">
			<article>
				<h1>Estructuras
				<b>metalicas para la industria</b></h1>
				<h2>Ventajas</h2>
		        <p><b>Amplio rango de productos</b><br>
		        Somos capaces de diseñar y manufacturar equipos industriales como: Intercambiadores de calor, reactores, suavizadores de agua, filstros de aire, filtros de carbono y antracita, colectores de polvo, secadores de arena, silos, elevadores, bandas, contenedores presurizados, tanques atmosféricos, tanques de presión.</p>
		        <p><b>Amplio rango de capacidades</b><br>
		        Tenemos capacidades para fabricar estructuras ligeras, de mediana densidad y de alta integridad, permitiendo cumplir con las necesidades del cliente de acuerdo al diseño establecido.</p>
			<div class="img-left">
				<img src="images/estructura-2.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p><b>Experiencia</b><br>
				Mediante la experiencia en la industria, podemos segurir a nuestros clientes la estructura o equipo ideal para su proceso, incluyendo dimensionamiento, selección de materiales y simulaciones previas a la fabricación.</p>
			</div>
			<div class="img-left-min">
				<img src="images/estructura-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p><b>Estructuras prefabricadas</b><br>
				Para facilitar la integración en su sistema podemos generar estructuras prefabricadas que se adapten a sus necesidades permitiendo con esto cumplir con su proceso productivo de manera eficiente.</p>
			</div>
