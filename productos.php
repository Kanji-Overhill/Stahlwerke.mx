...
<head>
	...
	<link rel="stylesheet" type="text/css" media="none" onload="if(media!='all')media='all'" href="css/styles-productos.css">
	...
	<link rel="canonical" href="http://stahlwerke.mx/productos" />
</head>
<body>
	<header>
		<nav> 
	...
	<main style="background-image: url(images/productos-fondo.jpg);">
		<section class="productos-sec-1">
			<article class="title">	
			<h1>Stahl Werke <b>Productos</b></h1>
			<p>Stahl Werke permite que usted como cliente llegue a sus metas de producción y eficiencia a pesar de su tamaño de sistema o estructura.</p>
			<a href="contacto">Cotiza ahora</a>
			</article>
			<article class="links">
				<div>
					<a href="elevacion-almacenamiento">
						<img src="images/product-1.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Elevación y almacenamiento</p>
					</a>
				</div>
				<div>
					<a href="sistemas-verificacion">
						<img src="images/product-2.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Verificación de calidad</p>
					</a>
				</div>
				<div>
					<a href="brazos-articulados">
						<img src="images/product-3.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Brazos articulados</p>
					</a>
				</div>
				<div>
					<a href="ayudas-ergonomicas">
						<img src="images/product-4.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Ayudas ergonómicas</p>
					</a>
				</div>
				<div>
					<a href="estructuras-equipo">
						<img src="images/product-5.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Estructuras de acero</p>
					</a>
				</div>
				<div>
					<a href="simulaciones">
						<img src="images/product-6.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Capacidad de equipos</p>
					</a>
				</div>
			</article>
		</section>
