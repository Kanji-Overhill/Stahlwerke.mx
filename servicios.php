...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/servicios" />
</head>
<body>
	<header>
		<nav> 
	...
	<main style="background-image: url(images/servicios-fondo.jpg);">
		<section class="productos-sec-1">
			<article class="title" style="max-width: 800px;">	
			<h1>Stahl Werke <b>servicios</b></h1>
			<p style="max-width: 456px;">Stahl Werke brinda asesoría técnica especializada para el desarrollo, análisis e interpretación del conjunto de antecendentes y otros datos necesarios que permiten demostrar las factibilidades de un nuevo proyecto a emprender.</p>
			<a href="contacto">Cotiza ahora</a>
			</article>
			<article class="links" style="text-align:center">
				<div style="max-width: 170px;">
					<a href="preparacion-trabajo">
						<img src="images/serv-1.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>Preparacion</p>
					</a>
				</div>
				<div style="max-width: 170px;">
					<a href="simulaciones">
						<img src="images/serv-2.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>simulaciones</p>
					</a>
				</div>
				<div style="max-width: 170px;">
					<a href="ingenieria">
						<img src="images/serv-4.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>ingeniería</p>
					</a>
				</div>
				<div style="max-width: 170px;">
					<a href="flujo-procesos">
						<img src="images/serv-5.png" alt="estructuras metalicas, naves industriales, equipos industriales">
					    <p>flujo de procesos</p>
					</a>
				</div>
			</article>
		</section>
