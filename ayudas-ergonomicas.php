...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/ayudas-ergonomicas" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/ayudas.jpg); background-size: cover">
			<article>
		...
		<section class="scroll-page">
			<article>
				...
				<b>ergonómicas</b></h1>
				<h2>Ventajas</h2>
		        <p><b>Reducción de costos</b><br>
		        Al evitar los riesgos ergonómicos se pueden reducir costos de seguros en la industria. Es importante mencionar que una vez que el empleado se lastima los costos indirectos pueden alcanzar hasta 20 veces el costo del evento</p>
		        <div class="img-left-min">
				<img src="images/ayudas-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p><b>Mejora de productividad</b><br>
				Al diseñar una estación de trabajo para permitir menores movimientos, mejores alturas y alcances, la estación se vuelva más eficiente, permitiendo que el empleado mantenga su nivel de energía y lo utilice en la producción</p>
			</div>
			<div class="img-right">
				<p><b>Mejora de calidad</b><br>
				Un bajo nivel ergonómico genera trabajadores frustrados y fatigados que no realizan el trabajo al nivel de sus capacidades. Cuando el trabajo es muy agotante no lo ejercerán conforme fueron entrenados. Esto es de especial importancia en actividades de ensamble de precisión.</p>
				<img src="images/ayudas-2.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
			</div>
			<p><b>Mejora de compromiso del empleado</b><br>
			Los empleados notan cuando la compañía pone un esfuerzo para asegurar su salud y seguridad. Si un empleado no experimienta fatiga e incomodidad durante el día esto puede reducir el ausentismo, mejorar la moral e incrementar el compromiso del empleado en ggeneral.</p>
			<p><b>Incremento de cultura de la seguridad</b><br>
			Mediante la implementación de estos sistemas se muestra el compromiso de la empresa con la seguridad y salud. Los empleados saludables son su valor más preciado, el fomentar esta cultura genera un mejor desempeño para su organización.</p>
