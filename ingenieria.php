...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/ingenieria" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/ingenieria.jpg);">
			<article>
				<div class="parrafos">
					<p>
						<b>Dassault Sistemas</b>
						CATIA V5<br>
						R19
					</p>
				</div>
		...
		<section class="scroll-page">
			<article>
				<h1>Ingenieria</h1>
			<h2>Ingenieros calificados</h2><br>
			<p>
				En Stahl Werke contamos con ingenieros calificados para el desarrollo, diseño y construcción de modelos matemáticos y la integración de los mismos a sistemas metal mecánicos y de automatización.<br><br>
				Para ofrecer herramientas que den certidumbre a los proyectos de nuestros clientes contamos con Software de última generación.
			</p>
			<div class="img-left">
				<img src="images/ingenieria-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
				<p>Ofrecemos soluciones a las industrias en general mediante la integración de sistemas y componentes de los más altos estándares. Contamos con procedimientos de ingeniería integral como lo son: CAD, CAM y CAE. Esto nos permite apoyar en cualquier etapa del proceso requerido por sus empresas.</p>
			</div>
