...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/preparacion-trabajo" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
		<section class="fixed-page" style="background-image: url(images/preparacion-trabajo.jpg); background-size: cover;">
			<article>
		...
		<section class="scroll-page">
			<article>
				<h1>Preparación para el trabajo</h1>
				<p>Stahl Werke brinda asesoría técnica especializada para el desarrollo,
				análisis e interpretación del conjunto de antecedentes y otros datos necesarios que permiten demostrar las factibilidades de un nuevo proyecto a emprender. Entre éstas, se encuentran las viabilidades:</p>
			<img class="imagen-total" src="images/preparacion-1.jpg" alt="estructuras metalicas, naves industriales, equipos industriales">
			<ul class="lista-cuadrados">
				...
				<li>Técnicas</li>
				<li>Análisis de ventajas y desventajas del proyecto</li>
			</ul>
			<p>El análisis de factibilidad que conforma la preparación del trabajo estará respaldado por el desarrollo de un diseño conceptual previo (en relación con los objetivos definidos). Para su construcción, análisis y enriquecimiento, deberá incluirse lo siguiente:</p>
			<ul class="lista-2-colores">
				<li>Planos preliminares (layout)</li>
				<li>Clasificación de áreas</li>
				<li>Esquemas</li>
				<li>Flujos de personas y materiales</li>
				<li>Diagramas de proceso</li>
				<li>Valoraciones económicas estimativas</li>
			</ul>
			<img src="images/preparacion-2.jpg" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
			<p>Una vez que los datos previamente seleccionados sean correctamente analizados, Stahl Werke brindará soluciones al desarrollo de ingeniería de los clientes, a través de la construcción de hipótesis y generación de indicadores que permitan tomar la desición correcta. Así, nuestros clientes mitigarán aquellos riesgos asociadosal emprendimiento de nuevos proyectos y aumentarán la competitividad de sus productos ofreciendo un valor agregado, perceptible a las necesidades de mercado.</p>
			<h2>Ventajas</h2>
			<ul class="lista-2-colores">
				<li>Indentificación del problema</li>
				<li>Análisis comparativo de posibles soluciones</li>
				<li>Materiales</li>
				<li>Técnica</li>
				<li>Operaciones</li>
				<li>Costos</li>
				<li>Recursos</li>
				<li>Estimación de costos basados en proyecciones financieras</li>
				<li>Generación de archivos gráficos: alternativas preliminares del diseño</li>
				<li>Evaluación de características del proyecto</li>
				<li>Memoria justificativa: Solución gráfica, estética y funcional</li>
				<li>Mejorar comunicación de valor entre el proveedor y el cliente</li>
				<li>Delimitación de actividad cuello de botella</li>
				<li>Análisis para disminuir cuello de botella</li>
				<li>Limitación de problemas por circunstancias aleatorias</li>
				<li>Aseguramiento de calidad mediante estaciones con poka yokes</li>
				<li>Mecanización del trabajo</li>
				<li>Puntos de soldadura</li>
			</ul>
