...
<head>
	<meta charset="UTF-8"> 
	<title>Construccion de Estacionamientos Automatizados</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="En StahlWerke diseñamos y construimos naves industriales, estructuras metálicas, Estacionamientos automatizados, Equipos Industriales, racks, y mucho mas">
	...
	<link rel="canonical" href="http://stahlwerke.mx/sistemas-almacenamiento" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
	 <iframe id="player" src="http://www.youtube.com/embed/JTXj8I2Hyq4?autoplay=1&loop=1&playlist=JTXj8I2Hyq4&showinfo=0&controls=0" frameborder="0" allowfullscreen></iframe>
		...
		<section class="scroll-page">
			<article>
				<h1 class="font-size50"><b style="font-size:21px;">Sistemas logísticos de almacenaje</b><br>automatizado</h1>
		        <p>Diseño, fabricación, integración, instalación y puesta en marcha de sistemas automatizados para almacenes logísticos en general. 
                Contamos con experiencia en el ramo de automatización de estacionamientos urbanos. Integramos componentes de la más alta calidad Europea con presencia y servicio técnico en América. Así mismo contamos con la integración de sistemas de software de gestión inteligente que permiten controlar las secuencias dentro del almacén.</p>
		        <ul class="lista-2-colores">
		        	<li>Reducción de costos de reurbanización</li>
		        	<li>Eficiente y económico</li>
		        	<li>Ahorro de construcción (Excavación)</li>
		        	<li>Eliminación de la necesidad de rampas</li>
		        	<li>Seguro y estético</li>
		        	<li>Disminución de emisiones contaminantes</li>
		        	<li>Totalmente automatizado</li>
		        	<li>Aumento en la rentabilidad por metro cuadrado</li>
		        	<li>También ofrecemos apoyo para la obtención de la certificación LEED  (Leadership in Energy & Environmental Design)</li>
		        </ul>
