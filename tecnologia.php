...
<head>
	...
	<link rel="canonical" href="http://stahlwerke.mx/tecnologia" />
</head>
<body>
	<header>
		<nav> 
	...
	<main>
	 <iframe id="player" src="http://www.youtube.com/embed/JTXj8I2Hyq4?autoplay=1&loop=1&playlist=JTXj8I2Hyq4&showinfo=0&controls=0" frameborder="0" allowfullscreen></iframe>
		...
		<section class="scroll-page">
			<article>
				<h1><b>Equipamiento</b><br>Tecnológico</h1>
				<img src="images/lista1.png" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
				<h2>Capacidades</h2>
		        <img src="images/tabla-1.png" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
		        <p class="text-bold-2">CIZALLA PUNZONADORA</p>
		        <ul class="lista-2-colores">
		        	<li>Corte de Platina 600 x 15 mm.</li>
		        	<li>400 x 20 mm. Punzonado Ø 40 x 20 mm.</li>
		        	<li>Ø 28 x 28 mm. Corte de L a 90º 152 x 152 x 13 mm. </li>
		        	<li>Corte de barras macizas Ø 50 mm Y □50 mm. </li>
		        	<li>Entallado rectangular 90 x 52 x 13 mm.</li>
		        </ul>
		        <img src="images/tabla-2.png" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
		        <img src="images/tabla-3.png" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
		        <img src="images/tabla-4.png" alt="estructuras metalicas, naves industriales, equipos industriales" class="imagen-total">
		        <p class="text-bold-2">DOBLADORA DE ALAMBRE:</p>
		        <ul class="lista-2-colores">
		        	<li>Rango diámetro de alambre 2-8 mm. </li>
		        	<li>Máxima tensión de alambre 620/n/mm2. 90 kpsi. </li>
		        	<li>Velocidad alimentador 120 m/min</li>
		        </ul>
		        <p class="text-bold-2">CORTE POR HILO:</p>
		        <ul class="lista-2-colores">
		        	<li>Eje x 350 mm, eje y 250 mm, eje z 250 mm</li>
		        	<li>Pieza de trabajo de 820 x 680 250 mm, 400 kg</li>
		        	<li>Recorrido u, v +-45 mm</li>
		        </ul>
		        <p class="text-bold-2">ROLADORA:</p>
		        <ul class="lista-2-colores">
		        	<li>24 rollos, 300 mm distancia entre rollos</li>
		        	<li>Altura de mesa al centro de rollo 130 mm</li>
		        	<li>Diámetro de rollo 200 mm</li>
		        </ul>
		        <p class="text-bold-2">CENTROS DE MAQUINADO:</p>
		        <ul class="lista-2-colores">
		        	<li>Eje x (1020 mm, 800 mm, 540 mm, 1830 mm, 580 mm)</li>
		        	<li>Eje y (510 mm, 540 mm, 540 mm, 815 mm, 420 mm)</li>
		        	<li>Eje z (560 mm, 720 mm, 720 mm, 815 mm, 510 mm)</li>
		        	<li>Mesa de (1118 x 560 mm, 950 x 520 mm, 720 x 520 mm, 2430 x 815 mm, 650 x 240 mm)</li>
		        	<li>Carga de mesa de (698 kg, 750 kg, 500 kg, 2700 kg, 300 kg)</li>
		        	<li>Velocidad de eje 8000 rpm</li>
		        	<li>Control fanuc</li>
		        </ul>
